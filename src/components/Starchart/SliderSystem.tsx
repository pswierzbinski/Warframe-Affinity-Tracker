...
const SliderSystem: React.FC<SliderSystemProps> = ({ systemName, systemNodes, setMastered, setAllMastered }: SliderSystemProps) => {
  ...
  return (
    <div className="pt-24">
      <Card className="bg-white/15 border border-white/20 overflow-visible min-w-[320px] w-full">
        ...
        <CardHeader className="flex-col pt-28 pb-4 gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-6 text-white/80 px-4 py-2 rounded-xl bg-white/10 w-full">
            <span className="text-center">Mark all</span>
            <div className="flex flex-row justify-center gap-3">
              ...
              <div className="light flex justify-center">
                <Checkbox
        ...
        <CardBody className="px-4 divide-y divide-white/10">
          {systemNodes.map((node) => (
            <div
              ...
              <span className="text-sm text-white flex-1 truncate pr-2">
                {node.name}
              </span>
