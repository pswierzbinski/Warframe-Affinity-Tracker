    ...
    return (
        <>
            <Navbar
                isBlurred
                classNames={{
                    base: "bg-gray-100 min-h-18.75 rounded-md backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100 w-full md:w-auto self-center mt-1 md:px-2",
                    wrapper: "px-4 overflow-x-auto md:overflow-x-visible overflow-y-hidden scrollbar-hide",
                    content: "flex-nowrap gap-2 md:gap-4"
                }}
                maxWidth="full"
                height={75}
            >
                ...
                <NavbarContent>
                    ...
                    <NavbarItem className="group">
                        <div className="grid relative mt-2 w-40 md:w-60 flex-1">
                            <span
                            ...
                            <span className="mt-3 text-xs text-white justify-self-center">
